...
contains
   SUBROUTINE c__PDAFomi_assimilate_local_nondiagR(collect_state_pdaf,  &
      ...
      l2g_state_pdaf, next_observation_pdaf, outflag) bind(c)
      ! Status flag
   ...
   SUBROUTINE c__PDAFomi_assimilate_global_nondiagR(collect_state_pdaf,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_enkf_nondiagR(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
      ...
      procedure(c__add_obs_err_pdaf) :: add_obs_error_pdafomi
   ...
   SUBROUTINE c__PDAFomi_assimilate_lenkf_nondiagR(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
      prepoststep_pdaf, localize_covar_pdafomi, add_obs_error_pdafomi,  &
      init_obscovar_pdafomi, next_observation_pdaf, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
      ...
      procedure(c__localize_covar_pdaf) :: localize_covar_pdafomi
      ! Provide product R^-1 A
      procedure(c__add_obs_err_pdaf) :: add_obs_error_pdafomi
      ! Initialize mean observation error variance
      procedure(c__init_obs_covar_pdaf) :: init_obscovar_pdafomi
   ...
   SUBROUTINE c__PDAFomi_assimilate_nonlin_nondiagR(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
      likelihood_pdafomi, prepoststep_pdaf, next_observation_pdaf, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
      ...
      procedure(c__obs_op_pdaf) :: obs_op_pdafomi
      ! Compute likelihood
      procedure(c__likelihood_pdaf) :: likelihood_pdafomi
      ! User supplied pre/poststep routine
      procedure(c__prepoststep_pdaf) :: prepoststep_pdaf
      ! Provide time step, time and dimension of next observation
      procedure(c__next_observation_pdaf) :: next_observation_pdaf
   ...
   SUBROUTINE c__PDAFomi_assimilate_lnetf_nondiagR(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
      prepoststep_pdaf, init_n_domains_pdaf, init_dim_l_pdaf,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_lenkf(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdaf, obs_op_pdaf, prepoststep_pdaf,  &
      localize_covar_pdaf, next_observation_pdaf, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
   ...
   SUBROUTINE c__PDAFomi_assimilate_ensrf(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdaf, obs_op_pdaf, prepoststep_pdaf,  &
      localize_covar_serial_pdaf, next_observation_pdaf, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
      ...
      ! User supplied pre/poststep routine
      procedure(c__prepoststep_pdaf) :: prepoststep_pdaf
      ! Apply localization to HP and BXY
      procedure(c__localize_covar_serial_pdaf) :: localize_covar_serial_pdaf
      ! Provide time step, time and dimension of next observation
      procedure(c__next_observation_pdaf) :: next_observation_pdaf
   ...
   SUBROUTINE c__PDAFomi_assimilate_3dvar(collect_state_pdaf,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_en3dvar_estkf(collect_state_pdaf,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_en3dvar_lestkf(collect_state_pdaf,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_hyb3dvar_estkf(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdaf, obs_op_pdaf, cvt_ens_pdaf,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_hyb3dvar_lestkf(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_f_pdaf, obs_op_f_pdaf, cvt_ens_pdaf,  &
      cvt_adj_ens_pdaf, cvt_pdaf, cvt_adj_pdaf, obs_op_lin_pdaf,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_3dvar_nondiagR(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
      prodrinva_pdafomi, cvt_pdaf, cvt_adj_pdaf, obs_op_lin_pdafomi,  &
      obs_op_adj_pdafomi, prepoststep_pdaf, next_observation_pdaf, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
   ...
   SUBROUTINE c__PDAFomi_assimilate_en3dvar_estkf_nondiagR(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_en3dvar_lestkf_nondiagR(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
      prodrinva_pdafomi, cvt_ens_pdaf, cvt_adj_ens_pdaf, obs_op_lin_pdafomi,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_hyb3dvar_estkf_nondiagR(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
   ...
   SUBROUTINE c__PDAFomi_assimilate_hyb3dvar_lestkf_nondiagR( &
   ...
   SUBROUTINE c__PDAFomi_generate_obs(collect_state_pdaf,  &
      distribute_state_pdaf, init_dim_obs_f_pdaf, obs_op_f_pdaf,  &
      get_obs_f_pdaf, prepoststep_pdaf, next_observation_pdaf, outflag) bind(c)
      ! Status flag
