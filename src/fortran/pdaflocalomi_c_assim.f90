...
contains
   SUBROUTINE c__PDAFlocalomi_assimilate(collect_state_pdaf,  &
      ...
      call PDAFlocalomi_assimilate(f__collect_state_pdaf, f__distribute_state_pdaf,  &
   ...
   SUBROUTINE c__PDAFlocalomi_assimilate_nondiagR(collect_state_pdaf,  &
      ...
      call PDAFlocalomi_assimilate_nondiagR(f__collect_state_pdaf,  &
         ...
         f__init_dim_obs_l_pdaf, f__prodrinva_l_pdaf, f__next_observation_pdaf,  &
         outflag)
   ...
   SUBROUTINE c__PDAFlocalomi_assimilate_lnetf_nondiagR(collect_state_pdaf,  &
      ...
      call PDAFlocalomi_assimilate_lnetf_nondiagR(f__collect_state_pdaf,  &
         f__distribute_state_pdaf, f__init_dim_obs_pdaf, f__obs_op_pdaf,  &
         f__prepoststep_pdaf, f__init_n_domains_p_pdaf, f__init_dim_l_pdaf,  &
         f__init_dim_obs_l_pdaf, f__likelihood_l_pdaf, f__next_observation_pdaf,  &
         outflag)
   ...
   SUBROUTINE c__PDAFlocalomi_assimilate_lknetf_nondiagR(collect_state_pdaf,  &
      ...
      call PDAFlocalomi_assimilate_lknetf_nondiagR(f__collect_state_pdaf,  &
         f__distribute_state_pdaf, f__init_dim_obs_pdaf, f__obs_op_pdaf,  &
         f__prepoststep_pdaf, f__init_n_domains_p_pdaf, f__init_dim_l_pdaf,  &
         f__init_dim_obs_l_pdaf, f__prodrinva_l_pdaf, f__prodrinva_hyb_l_pdaf,  &
         f__likelihood_l_pdaf, f__likelihood_hyb_l_pdaf, f__next_observation_pdaf,  &
         outflag)
   ...
   SUBROUTINE c__PDAFlocalomi_assimilate_en3dvar_lestkf(collect_state_pdaf,  &
      ...
      call PDAFlocalomi_assimilate_en3dvar_lestkf(f__collect_state_pdaf,  &
   ...
   SUBROUTINE c__PDAFlocalomi_assimilate_hyb3dvar_lestkf(collect_state_pdaf,  &
      ...
      call PDAFlocalomi_assimilate_hyb3dvar_lestkf(f__collect_state_pdaf,  &
         f__distribute_state_pdaf, f__init_dim_obs_f_pdaf, f__obs_op_f_pdaf,  &
   ...
   SUBROUTINE c__PDAFlocalomi_assimilate_en3dvar_lestkf_nondiagR( &
      ...
      call PDAFlocalomi_assimilate_en3dvar_lestkf_nondiagR(f__collect_state_pdaf,  &
         f__distribute_state_pdaf, f__init_dim_obs_pdaf, f__obs_op_pdaf,  &
   ...
   SUBROUTINE c__PDAFlocalomi_assimilate_hyb3dvar_lestkf_nondiagR( &
      ...
      call PDAFlocalomi_assimilate_hyb3dvar_lestkf_nondiagR(f__collect_state_pdaf,  &
         f__distribute_state_pdaf, f__init_dim_obs_pdaf, f__obs_op_pdaf,  &
