...
contains
   SUBROUTINE c__PDAFlocalomi_put_state_en3dvar_lestkf(collect_state_pdaf,  &
      ...
      call PDAFlocalomi_put_state_en3dvar_lestkf(f__collect_state_pdaf,  &
   ...
   SUBROUTINE c__PDAFlocalomi_put_state_hyb3dvar_lestkf(collect_state_pdaf,  &
      ...
      call PDAFlocalomi_put_state_hyb3dvar_lestkf(f__collect_state_pdaf,  &
         f__init_dim_obs_f_pdaf, f__obs_op_f_pdaf, f__cvt_ens_pdaf, f__cvt_adj_ens_pdaf,  &
   ...
   SUBROUTINE c__PDAFlocalomi_put_state_en3dvar_lestkf_nondiagR( &
      collect_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
      ...
      init_dim_l_pdaf, init_dim_obs_l_pdafomi, prepoststep_pdaf, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
      ...
      call PDAFlocalomi_put_state_en3dvar_lestkf_nondiagR(f__collect_state_pdaf,  &
   ...
   SUBROUTINE c__PDAFlocalomi_put_state_hyb3dvar_lestkf_nondiagR( &
      collect_state_pdaf, init_dim_obs_pdafomi, obs_op_pdafomi,  &
      ...
      init_dim_obs_l_pdafomi, prepoststep_pdaf, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
      ...
      call PDAFlocalomi_put_state_hyb3dvar_lestkf_nondiagR(f__collect_state_pdaf,  &
         f__init_dim_obs_pdaf, f__obs_op_pdaf, f__prodrinva_pdaf, f__cvt_ens_pdaf,  &
   ...
   SUBROUTINE c__PDAFlocalomi_put_state(collect_state_pdaf,  &
      init_dim_obs_f_pdaf, obs_op_f_pdaf, prepoststep_pdaf,  &
      init_n_domains_pdaf, init_dim_l_pdaf, init_dim_obs_l_pdaf, outflag) bind(c)
      ! Status flag
      ...
      call PDAFlocalomi_put_state(f__collect_state_pdaf, f__init_dim_obs_f_pdaf,  &
         f__obs_op_f_pdaf, f__prepoststep_pdaf, f__init_n_domains_p_pdaf, f__init_dim_l_pdaf,  &
         f__init_dim_obs_l_pdaf, outflag)
   ...
   SUBROUTINE c__PDAFlocalomi_put_state_nondiagR(collect_state_pdaf,  &
      ...
      prodrinva_l_pdafomi, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
      ...
      call PDAFlocalomi_put_state_nondiagR(f__collect_state_pdaf,  &
         f__init_dim_obs_pdaf, f__obs_op_pdaf, f__prepoststep_pdaf,  &
         f__init_n_domains_p_pdaf, f__init_dim_l_pdaf, f__init_dim_obs_l_pdaf,  &
         f__prodrinva_l_pdaf, outflag)
   ...
   SUBROUTINE c__PDAFlocalomi_put_state_lnetf_nondiagR(collect_state_pdaf,  &
      init_dim_obs_pdafomi, obs_op_pdafomi, prepoststep_pdaf,  &
      init_n_domains_pdaf, init_dim_l_pdaf, init_dim_obs_l_pdafomi,  &
      likelihood_l_pdafomi, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
      ...
      call PDAFlocalomi_put_state_lnetf_nondiagR(f__collect_state_pdaf,  &
         f__init_dim_obs_pdaf, f__obs_op_pdaf, f__prepoststep_pdaf,  &
         f__init_n_domains_p_pdaf, f__init_dim_l_pdaf, f__init_dim_obs_l_pdaf,  &
         f__likelihood_l_pdaf, outflag)
   ...
   SUBROUTINE c__PDAFlocalomi_put_state_lknetf_nondiagR(collect_state_pdaf,  &
      ...
      likelihood_hyb_l_pdafomi, outflag) bind(c)
      ! Status flag
      INTEGER(c_int), INTENT(out) :: outflag
      ...
      call PDAFlocalomi_put_state_lknetf_nondiagR(f__collect_state_pdaf,  &
         f__init_dim_obs_pdaf, f__obs_op_pdaf, f__prepoststep_pdaf,  &
         f__init_n_domains_p_pdaf, f__init_dim_l_pdaf, f__init_dim_obs_l_pdaf,  &
