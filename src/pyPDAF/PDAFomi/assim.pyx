...
def assimilate_local_nondiagr(py__collect_state_pdaf,
    ...
    py__init_dim_obs_l_pdaf, py__prodrinva_l_pdaf, py__g2l_state_pdaf,
    py__l2g_state_pdaf, py__next_observation_pdaf):
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_local_nondiagr(pdaf_cb.c__collect_state_pdaf,
...
def assimilate_global_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_global_nondiagr(
...
def assimilate_enkf_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_enkf_nondiagr(pdaf_cb.c__collect_state_pdaf,
                                            pdaf_cb.c__distribute_state_pdaf,
                                            pdaf_cb.c__init_dim_obs_pdaf,
                                            pdaf_cb.c__obs_op_pdaf,
...
def assimilate_lenkf_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_lenkf_nondiagr(pdaf_cb.c__collect_state_pdaf,
                                             pdaf_cb.c__distribute_state_pdaf,
                                             pdaf_cb.c__init_dim_obs_pdaf,
                                             pdaf_cb.c__obs_op_pdaf,
                                             pdaf_cb.c__prepoststep_pdaf,
...
def assimilate_nonlin_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_nonlin_nondiagr(
                                              pdaf_cb.c__collect_state_pdaf,
                                              pdaf_cb.c__distribute_state_pdaf,
                                              pdaf_cb.c__init_dim_obs_pdaf,
                                              pdaf_cb.c__obs_op_pdaf,
...
def assimilate_lnetf_nondiagr(py__collect_state_pdaf,
    py__distribute_state_pdaf, py__init_dim_obs_pdaf, py__obs_op_pdaf,
    py__prepoststep_pdaf, py__init_n_domains_p_pdaf, py__init_dim_l_pdaf,
    py__init_dim_obs_l_pdaf, py__likelihood_l_pdaf, py__g2l_state_pdaf,
    py__l2g_state_pdaf, py__next_observation_pdaf):
    """Checking the corresponding PDAF documentation in https://pdaf.awi.de
    For internal subroutines checking corresponding PDAF comments.
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_lnetf_nondiagr(pdaf_cb.c__collect_state_pdaf,
                                             pdaf_cb.c__distribute_state_pdaf,
                                             pdaf_cb.c__init_dim_obs_pdaf,
                                             pdaf_cb.c__obs_op_pdaf,
                                             pdaf_cb.c__prepoststep_pdaf,
...
def assimilate_lknetf_nondiagr(py__collect_state_pdaf,
    ...
    py__likelihood_hyb_l_pdaf, py__g2l_state_pdaf, py__l2g_state_pdaf,
    py__next_observation_pdaf):
    """Checking the corresponding PDAF documentation in https://pdaf.awi.de
    For internal subroutines checking corresponding PDAF comments.
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_lknetf_nondiagr(
                                              pdaf_cb.c__collect_state_pdaf,
                                              pdaf_cb.c__distribute_state_pdaf,
                                              pdaf_cb.c__init_dim_obs_pdaf,
                                              pdaf_cb.c__obs_op_pdaf,
...
def assimilate_local(py__collect_state_pdaf, py__distribute_state_pdaf,
    py__init_dim_obs_f_pdaf, py__obs_op_f_pdaf, py__prepoststep_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_local(pdaf_cb.c__collect_state_pdaf,
                                    pdaf_cb.c__distribute_state_pdaf,
...
def assimilate_global(py__collect_state_pdaf, py__distribute_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_global(pdaf_cb.c__collect_state_pdaf,
                                     pdaf_cb.c__distribute_state_pdaf,
                                     pdaf_cb.c__init_dim_obs_pdaf,
                                     pdaf_cb.c__obs_op_pdaf,
                                     pdaf_cb.c__prepoststep_pdaf,
...
def assimilate_lenkf(py__collect_state_pdaf, py__distribute_state_pdaf,
    py__init_dim_obs_pdaf, py__obs_op_pdaf, py__prepoststep_pdaf,
    py__localize_covar_pdaf, py__next_observation_pdaf):
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_lenkf(pdaf_cb.c__collect_state_pdaf,
                                    pdaf_cb.c__distribute_state_pdaf,
                                    pdaf_cb.c__init_dim_obs_pdaf,
                                    pdaf_cb.c__obs_op_pdaf,
                                    pdaf_cb.c__prepoststep_pdaf,
...
def assimilate_ensrf(py__collect_state_pdaf, py__distribute_state_pdaf,
    py__init_dim_obs_pdaf, py__obs_op_pdaf, py__prepoststep_pdaf,
    py__localize_covar_serial_pdaf, py__next_observation_pdaf):
    """Checking the corresponding PDAF documentation in https://pdaf.awi.de
    For internal subroutines checking corresponding PDAF comments.
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_ensrf(pdaf_cb.c__collect_state_pdaf,
                                    pdaf_cb.c__distribute_state_pdaf,
                                    pdaf_cb.c__init_dim_obs_pdaf,
                                    pdaf_cb.c__obs_op_pdaf,
                                    pdaf_cb.c__prepoststep_pdaf,
...
def assimilate_3dvar(py__collect_state_pdaf, py__distribute_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_3dvar(pdaf_cb.c__collect_state_pdaf,
                                    pdaf_cb.c__distribute_state_pdaf,
                                    pdaf_cb.c__init_dim_obs_pdaf,
                                    pdaf_cb.c__obs_op_pdaf,
                                    pdaf_cb.c__cvt_pdaf,
...
def assimilate_en3dvar_estkf(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_en3dvar_estkf(pdaf_cb.c__collect_state_pdaf,
                                            pdaf_cb.c__distribute_state_pdaf,
                                            pdaf_cb.c__init_dim_obs_pdaf,
                                            pdaf_cb.c__obs_op_pdaf,
...
def assimilate_en3dvar_lestkf(py__collect_state_pdaf,
    py__distribute_state_pdaf, py__init_dim_obs_f_pdaf, py__obs_op_f_pdaf,
    py__cvt_ens_pdaf, py__cvt_adj_ens_pdaf, py__obs_op_lin_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_en3dvar_lestkf(pdaf_cb.c__collect_state_pdaf,
                                             pdaf_cb.c__distribute_state_pdaf,
                                             pdaf_cb.c__init_dim_obs_f_pdaf,
                                             pdaf_cb.c__obs_op_f_pdaf,
                                             pdaf_cb.c__cvt_ens_pdaf,
...
def assimilate_hyb3dvar_estkf(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_hyb3dvar_estkf(pdaf_cb.c__collect_state_pdaf,
                                             pdaf_cb.c__distribute_state_pdaf,
                                             pdaf_cb.c__init_dim_obs_pdaf,
                                             pdaf_cb.c__obs_op_pdaf,
                                             pdaf_cb.c__cvt_ens_pdaf,
...
def assimilate_hyb3dvar_lestkf(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_hyb3dvar_lestkf(
                                              pdaf_cb.c__collect_state_pdaf,
                                              pdaf_cb.c__distribute_state_pdaf,
                                              pdaf_cb.c__init_dim_obs_f_pdaf,
                                              pdaf_cb.c__obs_op_f_pdaf,
...
def assimilate_3dvar_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_3dvar_nondiagr(pdaf_cb.c__collect_state_pdaf,
                                             pdaf_cb.c__distribute_state_pdaf,
                                             pdaf_cb.c__init_dim_obs_pdaf,
                                             pdaf_cb.c__obs_op_pdaf,
                                             pdaf_cb.c__prodrinva_pdaf,
...
def assimilate_en3dvar_estkf_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_en3dvar_estkf_nondiagr(
                                                     pdaf_cb.c__collect_state_pdaf,
                                                     pdaf_cb.c__distribute_state_pdaf,
                                                     pdaf_cb.c__init_dim_obs_pdaf,
                                                     pdaf_cb.c__obs_op_pdaf,
...
def assimilate_en3dvar_lestkf_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_en3dvar_lestkf_nondiagr(
                                                      pdaf_cb.c__collect_state_pdaf,
                                                      pdaf_cb.c__distribute_state_pdaf,
                                                      pdaf_cb.c__init_dim_obs_pdaf,
                                                      pdaf_cb.c__obs_op_pdaf,
...
def assimilate_hyb3dvar_estkf_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_hyb3dvar_estkf_nondiagr(
                                                      pdaf_cb.c__collect_state_pdaf,
                                                      pdaf_cb.c__distribute_state_pdaf,
                                                      pdaf_cb.c__init_dim_obs_pdaf,
                                                      pdaf_cb.c__obs_op_pdaf,
...
def assimilate_hyb3dvar_lestkf_nondiagr(py__collect_state_pdaf,
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_assimilate_hyb3dvar_lestkf_nondiagr(
                                                       pdaf_cb.c__collect_state_pdaf,
                                                       pdaf_cb.c__distribute_state_pdaf,
                                                       pdaf_cb.c__init_dim_obs_pdaf,
                                                       pdaf_cb.c__obs_op_pdaf,
...
def generate_obs(py__collect_state_pdaf, py__distribute_state_pdaf,
    py__init_dim_obs_f_pdaf, py__obs_op_f_pdaf, py__get_obs_f_pdaf,
    ...
    pdaf_cb.next_observation_pdaf = <void*>py__next_observation_pdaf
    with nogil:
        c__pdafomi_generate_obs(pdaf_cb.c__collect_state_pdaf,
                                pdaf_cb.c__distribute_state_pdaf,
                                pdaf_cb.c__init_dim_obs_f_pdaf,
                                pdaf_cb.c__obs_op_f_pdaf,
