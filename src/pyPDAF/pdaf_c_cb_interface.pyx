...
cdef object add_obs_err_pdaf = None;
cdef void c__add_obs_err_pdaf(int* step, int* dim_obs_p, double* c_p) noexcept with gil:
    ...
    c_p_np = add_obs_err_pdaf(step[0], dim_obs_p[0], c_p_np.base)
...
cdef object init_ens_pdaf = None;
cdef void c__init_ens_pdaf(int* filtertype, int* dim_p, int* dim_ens,
    ...
    state_p_np,uinv_np,ens_p_np,flag[0] = init_ens_pdaf(filtertype[0],
                                                        dim_p[0],
                                                        dim_ens[0],
                                                        state_p_np.base,
                                                        uinv_np.base,
...
cdef object next_observation_pdaf = None;
cdef void c__next_observation_pdaf(int* stepnow, int* nsteps, int* doexit,
    ...
    """
    nsteps[0],doexit[0],time[0] = next_observation_pdaf(stepnow[0],
                                                        nsteps[0],
                                                        doexit[0],
                                                        time[0])


cdef object collect_state_pdaf = None;
cdef void c__collect_state_pdaf(int* dim_p, double* state_p) noexcept with gil:
    ...
    state_p_np = collect_state_pdaf(dim_p[0], state_p_np.base)
...
cdef object distribute_state_pdaf = None;
cdef void c__distribute_state_pdaf(int* dim_p,
    ...
    state_p_np = distribute_state_pdaf(dim_p[0], state_p_np.base)
...
cdef object prepoststep_pdaf = None;
cdef void c__prepoststep_pdaf(int* step, int* dim_p, int* dim_ens,
    ...
    state_p_np,uinv_np,ens_p_np = prepoststep_pdaf(step[0],
                                                   dim_p[0],
                                                   dim_ens[0],
                                                   dim_ens_l[0],
                                                   dim_obs_p[0],
...
cdef object init_dim_obs_pdaf = None;
cdef void c__init_dim_obs_pdaf(int* step, int* dim_obs_p) noexcept with gil:
    ...
    dim_obs_p : int
        Dimension of the observation vector.
    """
    dim_obs_p[0] = init_dim_obs_pdaf(step[0], dim_obs_p[0])


cdef object init_dim_obs_f_pdaf = None;
cdef void c__init_dim_obs_f_pdaf(int* step, int* dim_obs_f) noexcept with gil:
    ...
    dim_obs_f : int
        Dimension of the full observation vector.
    """
    dim_obs_f[0] = init_dim_obs_f_pdaf(step[0], dim_obs_f[0])


cdef object init_obs_pdaf = None;
cdef void c__init_obs_pdaf(int* step, int* dim_obs_p,
    ...
    observation_p_np = init_obs_pdaf(step[0], dim_obs_p[0], observation_p_np.base)
...
cdef object init_obs_f_pdaf = None;
cdef void c__init_obs_f_pdaf(int* step, int* dim_obs_f,
    ...
    observation_f_np = init_obs_f_pdaf(step[0], dim_obs_f[0], observation_f_np.base)
...
cdef object init_obs_covar_pdaf = None;
cdef void c__init_obs_covar_pdaf(int* step, int* dim_obs, int* dim_obs_p,
    ...
    covar_np,isdiag[0] = init_obs_covar_pdaf(step[0], dim_obs[0],
                                            dim_obs_p[0],
                                            covar_np.base,
...
cdef object init_obsvar_pdaf = None;
cdef void c__init_obsvar_pdaf(int* step, int* dim_obs_p, double* obs_p,
    ...
    meanvar[0] = init_obsvar_pdaf(step[0], dim_obs_p[0], obs_p_np.base, meanvar[0])

cdef object init_obsvars_pdaf = None;
cdef void c__init_obsvars_pdaf(int* step, int* dim_obs_f,
    ...
    var_f_np = init_obsvars_pdaf(step[0], dim_obs_f[0], var_f_np.base)
...
cdef object prodrinva_pdaf = None;
cdef void c__prodrinva_pdaf(int* step, int* dim_obs_p, int* rank,
    ...
    c_p_np = prodrinva_pdaf(step[0], dim_obs_p[0], rank[0],
...
cdef void c__obs_op_pdaf(int* step, int* dim_p, int* dim_obs_p,
    ...
    m_state_p_np = obs_op_pdaf(step[0], dim_p[0], dim_obs_p[0],
...
cdef object obs_op_f_pdaf = None;
cdef void c__obs_op_f_pdaf(int* step, int* dim_p, int* dim_obs_p,
    ...
    m_state_p_np = obs_op_f_pdaf(step[0], dim_p[0], dim_obs_p[0],
                                 state_p_np.base, m_state_p_np.base)
...
cdef void c__g2l_obs_pdaf(int* domain_p, int* step, int* dim_obs_f,
    ...
    mstate_l_np = g2l_obs_pdaf(domain_p[0], step[0],
...
cdef object g2l_state_pdaf = None;
cdef void c__g2l_state_pdaf(int* step, int* domain_p, int* dim_p,
    ...
    state_l_np = g2l_state_pdaf(step[0], domain_p[0], dim_p[0],
...
cdef object init_dim_l_pdaf = None;
cdef void c__init_dim_l_pdaf(int* step, int* domain_p,
    ...
    dim_l[0] = init_dim_l_pdaf(step[0], domain_p[0], dim_l[0])

cdef object init_dim_obs_l_pdaf = None;
cdef void c__init_dim_obs_l_pdaf(int* domain_p, int* step, int* dim_obs_f,
    ...
    dim_obs_l: int
        Local observation vector dimension.
    """
    dim_obs_l[0] = init_dim_obs_l_pdaf(domain_p[0], step[0],
                                       dim_obs_f[0], dim_obs_l[0])

cdef object init_n_domains_p_pdaf = None;
cdef void c__init_n_domains_p_pdaf(int* step,
    ...
    n_domains_p: int
        Number of analysis domains.
    """
    n_domains_p[0] = init_n_domains_p_pdaf(step[0], n_domains_p[0])


cdef object init_obs_l_pdaf = None;
cdef void c__init_obs_l_pdaf(int* domain_p, int* step, int* dim_obs_l,
    ...
    observation_l_np = init_obs_l_pdaf(domain_p[0], step[0], dim_obs_l[0],
...
cdef object init_obsvar_l_pdaf = None;
cdef void c__init_obsvar_l_pdaf(int* domain_p, int* step, int* dim_obs_l,
    ...
    meanvar_l[0] = init_obsvar_l_pdaf(domain_p[0], step[0], dim_obs_l[0],
                                      obs_l_np.base, dim_obs_p[0], meanvar_l[0])


cdef object init_obserr_f_pdaf = None;
cdef void c__init_obserr_f_pdaf(int* step, int* dim_obs_f, double* obs_f,
    ...
    obserr_f_np = init_obserr_f_pdaf(step[0], dim_obs_f[0],
...
cdef object l2g_state_pdaf = None;
cdef void c__l2g_state_pdaf(int* step, int* domain_p, int* dim_l,
    ...
    state_p_np = l2g_state_pdaf(step[0], domain_p[0], dim_l[0],
...
cdef object prodrinva_l_pdaf = None;
cdef void c__prodrinva_l_pdaf(int* domain_p, int* step, int* dim_obs_l,
    ...
    a_l_np,c_l_np = prodrinva_l_pdaf(domain_p[0], step[0], dim_obs_l[0], rank[0],
                                     obs_l_np.base, a_l_np.base, c_l_np.base)
...
cdef object localize_covar_pdaf = None;
cdef void c__localize_covar_pdaf(int* dim_p, int* dim_obs, double* hp_p,
    ...
    hp_p_np,hph_np = localize_covar_pdaf(dim_p[0], dim_obs[0], hp_p_np.base, hph_np.base)
...
cdef object localize_covar_serial_pdaf = None;
cdef void c__localize_covar_serial_pdaf(int* iobs, int* dim_p,
    ...
    hp_p_np,hxy_p_np = localize_covar_serial_pdaf(iobs[0], dim_p[0], dim_obs[0],
                                                  hp_p_np.base, hxy_p_np.base)
...
cdef object likelihood_pdaf = None;
cdef void c__likelihood_pdaf(int* step, int* dim_obs_p, double* obs_p,
    ...
    likely[0] = likelihood_pdaf(step[0], dim_obs_p[0],
                                obs_p_np.base, resid_np.base, likely[0])


cdef object likelihood_l_pdaf = None;
cdef void c__likelihood_l_pdaf(int* domain_p, int* step, int* dim_obs_l,
    ...
    resid_l_np,likely_l[0] = likelihood_l_pdaf(domain_p[0], step[0],
                                               dim_obs_l[0], obs_l_np.base,
                                               resid_l_np.base, likely_l[0])
...
cdef object get_obs_f_pdaf = None;
cdef void c__get_obs_f_pdaf(int* step, int* dim_obs_f,
    ...
    observation_f_np = get_obs_f_pdaf(step[0], dim_obs_f[0], observation_f_np.base)
...
cdef object cvt_adj_ens_pdaf = None;
cdef void c__cvt_adj_ens_pdaf(int* iter_i, int* dim_p, int* dim_ens,
    ...
    cv_p_np = cvt_adj_ens_pdaf(iter_i[0], dim_p[0], dim_ens[0],
...
cdef object cvt_adj_pdaf = None;
cdef void c__cvt_adj_pdaf(int* iter_i, int* dim_p, int* dim_cvec,
    ...
    cv_p_np = cvt_adj_pdaf(iter_i[0], dim_p[0], dim_cvec[0], vcv_p_np.base, cv_p_np.base)
...
cdef object cvt_pdaf = None;
cdef void c__cvt_pdaf(int* iter_i, int* dim_p, int* dim_cvec, double* cv_p,
    ...
    vv_p_np = cvt_pdaf(iter_i[0], dim_p[0], dim_cvec[0], cv_p_np.base, vv_p_np.base)
...
cdef object cvt_ens_pdaf = None;
cdef void c__cvt_ens_pdaf(int* iter_i, int* dim_p, int* dim_ens,
    ...
    vv_p_np = cvt_ens_pdaf(iter_i[0], dim_p[0], dim_ens[0], dim_cvec_ens[0],
                           ens_p_np.base, v_p_np.base, vv_p_np.base)
...
cdef object obs_op_adj_pdaf = None;
cdef void c__obs_op_adj_pdaf(int* step, int* dim_p, int* dim_obs_p,
    ...
    state_p_np = obs_op_adj_pdaf(step[0], dim_p[0], dim_obs_p[0],
...
cdef object obs_op_lin_pdaf = None;
cdef void c__obs_op_lin_pdaf(int* step, int* dim_p, int* dim_obs_p,
    ...
    m_state_p_np = obs_op_lin_pdaf(step[0], dim_p[0], dim_obs_p[0],
                                   state_p_np.base, m_state_p_np.base)
...
cdef object likelihood_hyb_l_pdaf = None;
cdef void c__likelihood_hyb_l_pdaf(int* domain_p, int* step,
    ...
    resid_l_np,likely_l[0] = likelihood_hyb_l_pdaf(domain_p[0], step[0],
                                                   dim_obs_l[0], obs_l_np.base,
                                                   resid_l_np.base, gamma[0],
                                                   likely_l[0])
...
cdef object prodrinva_hyb_l_pdaf = None;
cdef void c__prodrinva_hyb_l_pdaf(int* domain_p, int* step, int* dim_obs_l,
    int* rank, double* obs_l, double* gamma, double* a_l, double* c_l) noexcept with gil:
    ...
    a_l_np,c_l_np = prodrinva_hyb_l_pdaf(domain_p[0], step[0], dim_obs_l[0],
                                         rank[0], obs_l_np.base, gamma[0],
