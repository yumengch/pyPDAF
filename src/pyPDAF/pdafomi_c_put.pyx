...
def put_state_local_nondiagr(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    py__g2l_state_pdaf, py__l2g_state_pdaf):
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_local_nondiagr(pdaf_cb.c__collect_state_pdaf, 
                                            ...
                                            pdaf_cb.c__l2g_state_pdaf, &outflag)
...
def put_state_global_nondiagr(py__collect_state_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_global_nondiagr(pdaf_cb.c__collect_state_pdaf, 
                                             pdaf_cb.c__init_dim_obs_pdaf, 
                                             pdaf_cb.c__obs_op_pdaf, 
...
def put_state_enkf_nondiagr(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_enkf_nondiagr(pdaf_cb.c__collect_state_pdaf, 
                                           pdaf_cb.c__init_dim_obs_pdaf, 
                                           pdaf_cb.c__obs_op_pdaf, 
...
def put_state_lenkf_nondiagr(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_lenkf_nondiagr(pdaf_cb.c__collect_state_pdaf, 
                                            pdaf_cb.c__init_dim_obs_pdaf, 
                                            pdaf_cb.c__obs_op_pdaf, 
                                            pdaf_cb.c__prepoststep_pdaf, 
...
def put_state_nonlin_nondiagr(py__collect_state_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_nonlin_nondiagr(pdaf_cb.c__collect_state_pdaf, 
                                             pdaf_cb.c__init_dim_obs_pdaf, 
                                             pdaf_cb.c__obs_op_pdaf, 
...
def put_state_lnetf_nondiagr(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_lnetf_nondiagr(pdaf_cb.c__collect_state_pdaf, 
                                            pdaf_cb.c__init_dim_obs_pdaf, 
                                            pdaf_cb.c__obs_op_pdaf, 
                                            pdaf_cb.c__prepoststep_pdaf, 
                                            pdaf_cb.c__init_n_domains_p_pdaf, 
...
def put_state_lknetf_nondiagr(py__collect_state_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_lknetf_nondiagr(pdaf_cb.c__collect_state_pdaf, 
                                             pdaf_cb.c__init_dim_obs_pdaf, 
                                             pdaf_cb.c__obs_op_pdaf, 
                                             pdaf_cb.c__prepoststep_pdaf, 
                                             pdaf_cb.c__init_n_domains_p_pdaf, 
...
def put_state_3dvar(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_3dvar(pdaf_cb.c__collect_state_pdaf, 
                                   pdaf_cb.c__init_dim_obs_pdaf, 
                                   pdaf_cb.c__obs_op_pdaf, 
                                   pdaf_cb.c__cvt_pdaf, 
...
def put_state_en3dvar_estkf(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_en3dvar_estkf(pdaf_cb.c__collect_state_pdaf, 
                                           pdaf_cb.c__init_dim_obs_pdaf, 
                                           pdaf_cb.c__obs_op_pdaf, 
...
def put_state_en3dvar_lestkf(py__collect_state_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_en3dvar_lestkf(pdaf_cb.c__collect_state_pdaf, 
...
def put_state_hyb3dvar_estkf(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_hyb3dvar_estkf(pdaf_cb.c__collect_state_pdaf, 
                                            pdaf_cb.c__init_dim_obs_pdaf, 
                                            pdaf_cb.c__obs_op_pdaf, 
                                            pdaf_cb.c__cvt_ens_pdaf, 
                                            pdaf_cb.c__cvt_adj_ens_pdaf, 
...
def put_state_hyb3dvar_lestkf(py__collect_state_pdaf, 
    ...
    py__l2g_state_pdaf, py__prepoststep_pdaf):
    """It is recommended to use
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_hyb3dvar_lestkf(pdaf_cb.c__collect_state_pdaf, 
                                             pdaf_cb.c__init_dim_obs_f_pdaf, 
                                             pdaf_cb.c__obs_op_f_pdaf, 
                                             pdaf_cb.c__cvt_ens_pdaf, 
                                             pdaf_cb.c__cvt_adj_ens_pdaf, 
...
def put_state_3dvar_nondiagr(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_3dvar_nondiagr(pdaf_cb.c__collect_state_pdaf, 
                                            pdaf_cb.c__init_dim_obs_pdaf, 
                                            pdaf_cb.c__obs_op_pdaf, 
                                            pdaf_cb.c__prodrinva_pdaf, 
                                            pdaf_cb.c__cvt_pdaf, 
...
def put_state_en3dvar_estkf_nondiagr(py__collect_state_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_en3dvar_estkf_nondiagr(
...
def put_state_en3dvar_lestkf_nondiagr(py__collect_state_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_en3dvar_lestkf_nondiagr(
                                                     pdaf_cb.c__collect_state_pdaf, 
                                                     pdaf_cb.c__init_dim_obs_pdaf, 
                                                     pdaf_cb.c__obs_op_pdaf, 
                                                     pdaf_cb.c__prodrinva_pdaf, 
...
def put_state_hyb3dvar_estkf_nondiagr(py__collect_state_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_hyb3dvar_estkf_nondiagr(
                                                     pdaf_cb.c__collect_state_pdaf, 
                                                     pdaf_cb.c__init_dim_obs_pdaf, 
                                                     pdaf_cb.c__obs_op_pdaf, 
                                                     pdaf_cb.c__prodrinva_pdaf, 
...
def put_state_hyb3dvar_lestkf_nondiagr(py__collect_state_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_hyb3dvar_lestkf_nondiagr(
                                                      pdaf_cb.c__collect_state_pdaf, 
                                                      pdaf_cb.c__init_dim_obs_pdaf, 
                                                      pdaf_cb.c__obs_op_pdaf, 
                                                      pdaf_cb.c__prodrinva_pdaf, 
...
def put_state_local(py__collect_state_pdaf, py__init_dim_obs_f_pdaf, 
    py__obs_op_f_pdaf, py__prepoststep_pdaf, py__init_n_domains_p_pdaf, 
    py__init_dim_l_pdaf, py__init_dim_obs_l_pdaf, py__g2l_state_pdaf, 
    py__l2g_state_pdaf, int  outflag):
    """Checking the corresponding PDAF documentation in https://pdaf.awi.de
    For internal subroutines checking corresponding PDAF comments.
    ...
    pdaf_cb.l2g_state_pdaf = <void*>py__l2g_state_pdaf
    with nogil:
        c__pdafomi_put_state_local(pdaf_cb.c__collect_state_pdaf, 
                                   pdaf_cb.c__init_dim_obs_f_pdaf, 
                                   pdaf_cb.c__obs_op_f_pdaf, 
                                   pdaf_cb.c__prepoststep_pdaf, 
                                   pdaf_cb.c__init_n_domains_p_pdaf, 
...
def put_state_global(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    pdaf_cb.prepoststep_pdaf = <void*>py__prepoststep_pdaf
    with nogil:
        c__pdafomi_put_state_global(pdaf_cb.c__collect_state_pdaf, 
                                    pdaf_cb.c__init_dim_obs_pdaf, 
                                    pdaf_cb.c__obs_op_pdaf, 
                                    pdaf_cb.c__prepoststep_pdaf, &outflag)
...
def put_state_lenkf(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_lenkf(pdaf_cb.c__collect_state_pdaf, 
                                   pdaf_cb.c__init_dim_obs_pdaf, 
                                   pdaf_cb.c__obs_op_pdaf, 
                                   pdaf_cb.c__prepoststep_pdaf, 
                                   pdaf_cb.c__localize_covar_pdaf, &outflag)
...
def put_state_ensrf(py__collect_state_pdaf, py__init_dim_obs_pdaf, 
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_ensrf(pdaf_cb.c__collect_state_pdaf, 
                                   pdaf_cb.c__init_dim_obs_pdaf, 
                                   pdaf_cb.c__obs_op_pdaf, 
...
def put_state_generate_obs(py__collect_state_pdaf, py__init_dim_obs_f_pdaf, 
    py__obs_op_f_pdaf, py__get_obs_f_pdaf, py__prepoststep_pdaf):
    ...
    cdef int  outflag
    with nogil:
        c__pdafomi_put_state_generate_obs(pdaf_cb.c__collect_state_pdaf, 
                                          pdaf_cb.c__init_dim_obs_f_pdaf, 
                                          pdaf_cb.c__obs_op_f_pdaf, 
