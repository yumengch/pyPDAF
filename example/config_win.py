...
init_ens_path:str = os.path.join('D:\\a\\pyPDAF\\pyPDAF\\inputs_online', 'ens_{i}.txt')
# path to initial truth
init_truth_path:str = os.path.join('D:\\a\\pyPDAF\\pyPDAF\\inputs_online', 'true_initial.txt')
